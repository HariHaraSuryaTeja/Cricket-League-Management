...
public class AddManagerActivity  extends AppCompatActivity {
    ...
    private void addManager(){
        pd = new ProgressDialog(AddManagerActivity.this);
        pd.setTitle("Please wait,Data is being submitted.");
        pd.show();
        ApiService api = RetroClient.getApiService();
        Call<ResModel> call = api.addManager(etManagerName.getText().toString(),etPhno.getText().toString(),etEmailID.getText().toString(),spTeamName.getSelectedItem().toString());
            ...
            public void onResponse(Call<ResModel> call, Response<ResModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if(rm.getStatus().equals("true")){
                        Toast.makeText(AddManagerActivity.this,rm.getMessage(),Toast.LENGTH_SHORT).show();
                ...
                if (response.isSuccessful()) {
                    ...
                    if(teams1!=null) {
                        if(teams1.size()>0) {
                            ...
                            ArrayAdapter<String> adp = new ArrayAdapter<String>(AddManagerActivity.this, android.R.layout.simple_spinner_dropdown_item, teams);
