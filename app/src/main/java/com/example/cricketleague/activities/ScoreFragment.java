...
import com.example.cricketleague.adapters.ScoreCardAdapter;
...
public class ScoreFragment extends Fragment {
    ...
    List<TeamModel> al;
    View view;
    public static ScoreFragment getScoreFragment() {
        ...
        call.enqueue(new Callback<List<TeamResultModel>>() {
            ...
            public void onResponse(Call<List<TeamResultModel>> call, Response<List<TeamResultModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    list_view.setAdapter(new ScoreCardAdapter(teams,getActivity()));
                }
            }
            @Override
