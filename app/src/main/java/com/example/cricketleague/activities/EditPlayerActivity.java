...
public class EditPlayerActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etPlayerName.setText(getIntent().getStringExtra("name"));
        ...
        btnAddPlayer.setText("Edit Player");
    ...
    private void editPlayer(){
        ...
        Call<ResModel> call = api.editPlayer(getIntent().getStringExtra("id"),etPlayerName.getText().toString(),etPhno.getText().toString(),etEmailID.getText().toString(),spTeamName.getSelectedItem().toString());
                ...
                if (response.isSuccessful()) {
                    ...
                    if(teams1!=null) {
                        if(teams1.size()>0) {
                            ...
                            ArrayAdapter<String> adp = new ArrayAdapter<String>(EditPlayerActivity.this, android.R.layout.simple_spinner_dropdown_item, teams);
